...
!(function (t) {
  ...
  function Y(t, n) {
    ...
    if ((t.v4shim && t.v4shim.enabled && c.push({id: 'fa-v4-shims', addOn: '-v4-shims'}), t.v5FontFaceShim && t.v5FontFaceShim.enabled && c.push({id: 'fa-v5-font-face', addOn: '-v5-font-face'}), t.v4FontFaceShim && t.v4FontFaceShim.enabled && c.push({id: 'fa-v4-font-face', addOn: '-v4-font-face'}), !a && t.customIconsCssPath)) {
  ...
  try {
    if (window.FontAwesomeKitConfig) {
      var V = window.FontAwesomeKitConfig,
        W = {detectingConflicts: V.detectConflictsUntil && new Date() <= new Date(V.detectConflictsUntil), detectionIgnoreAttr: 'data-fa-detection-ignore', fetch: window.fetch, token: V.token, XMLHttpRequest: window.XMLHttpRequest, document: document},
          ...
          t.map(function (t) {
            ...
            W.detectingConflicts &&
              ...
              J(function () {
                ...
                var t = (function (t, e) {
                  var n = document.createElement('script');
                  return e && e.detectionIgnoreAttr && n.setAttributeNode(document.createAttribute(e.detectionIgnoreAttr)), (n.src = O(t, {baseFilename: 'conflict-detection', fileSuffix: 'js', subdir: 'js', minify: t.minify.enabled})), n;
                })(V, W);
